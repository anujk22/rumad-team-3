              ...
              {rest.map(meetup => (
                <View key={meetup.id} style={[styles.meetupCard, isTablet ? { flex: 1, minWidth: 280 } : { width: '100%' }]}>
                  ...
                  <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    >
                      <Text style={[styles.joinBtnSmallText, meetup.am_attending && { color: '#fff' }]}>
...
const styles = StyleSheet.create({
  ...
  meetupCard: { backgroundColor: C.surfaceContainerLowest, borderRadius: 16, padding: 20, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.04, shadowRadius: 10, elevation: 2, borderWidth: 1, borderColor: 'rgba(228,190,186,0.2)', position: 'relative', overflow: 'hidden', minHeight: 200, justifyContent: 'space-between' },
