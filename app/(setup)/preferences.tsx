            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.disclaimerBox}>
                    <Text style={styles.disclaimerText}>
                        ...
                        <Text style={{ fontWeight: '700', color: '#af101a' }}>Settings</Text>.
                    </Text>
                </View>
...
const styles = StyleSheet.create({
    ...
    modeCard: {
        ...
        marginBottom: 16, borderWidth: 2, borderColor: 'rgba(228,190,186,0.4)',
    },
    modeCardActive: { borderColor: '#3b82f6', backgroundColor: 'rgba(59,130,246,0.04)' },
    modeCardActiveDating: { borderColor: '#af101a', backgroundColor: 'rgba(175,16,26,0.04)' },
    modeCardHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
    modeIcon: {
        width: 48, height: 48, borderRadius: 24,
        backgroundColor: 'rgba(228,190,186,0.3)', alignItems: 'center', justifyContent: 'center',
    },
    ...
    checkboxActiveDating: { backgroundColor: '#af101a', borderColor: '#af101a' },
    checkmark: { color: '#fff', fontSize: 16, fontWeight: '800' },
    modeTitle: { fontSize: 24, fontWeight: '800', color: '#1b1c1c', marginBottom: 4 },
    modeTitleActive: { color: '#3b82f6' },
    modeTitleActiveDating: { color: '#af101a' },
    modeDesc: { fontSize: 14, color: '#5f5e5e', lineHeight: 20 },
    ...
    disclaimerText: { fontSize: 13, color: '#705d00', textAlign: 'center', lineHeight: 20 },
    button: {
